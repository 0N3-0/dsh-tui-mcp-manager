...
async function runServerActions(ctx, dialogs, manager, credentials, icons, serverId) {
    while (true) {
        const lang = await resolveTuiLanguage(ctx);
        let snapshot;
        try {
...
function serverListOptions(lang, servers, icons) {
